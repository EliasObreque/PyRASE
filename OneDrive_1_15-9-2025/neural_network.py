...
class neural_network(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            nn.Linear(3, 10),   # input: 3 features 16 hidden neurons
...
optimizer = optim.Adam(model.parameters(), lr=0.0001) # updates weights in model based on gradients. lr is learning rate # our optimisation
